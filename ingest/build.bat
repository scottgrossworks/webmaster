@echo off
REM Build and Deploy Script for Ingest Lambda
REM Region: us-west-2
REM Function: webmaster-tyl-ingest

SET AWS_REGION=us-west-2
SET FUNCTION_NAME=webmaster-tyl-ingest
SET BUILD_DIR=build
SET ZIP_FILE=ingest.zip

echo ========================================
echo Building Ingest Lambda (ZIP)
echo ========================================
...
REM Step 2: Copy Lambda code and config
echo [2/3] Copying Lambda function code and LLM config...
copy lambda_function.py %BUILD_DIR%\
copy llm_config.json %BUILD_DIR%\
